...
import { 
  User, MapPin, Briefcase, Star, Mic, Video, 
  Upload, Search, CheckCircle2, Clock, DollarSign
} from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <SidebarProvider>
        <div className="flex min-h-screen w-full">
          <WorkerSidebar activeTab={activeTab} onTabChange={setActiveTab} />
            ...
            <div className="container py-8">
              ...
              <div className="grid lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-3">
                  ...
                  {activeTab === "feedback" && <WorkerFeedback />}
                  {activeTab === "references" && <WorkerReferences />}
                </div>
              </div>
            </div>
          </main>
